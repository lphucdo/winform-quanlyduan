...
{
    public partial class BaoCaoChiTietMay : Form
    {
        SqlConnection conn = Dao.DAO.GetConnection();
        public BaoCaoChiTietMay()
        {
            InitializeComponent();
        ...
        private void BaoCaoChiTietMay_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = DAO.GetConnection())
            {
                ...
                this.chiPhiMayBindingSource.DataSource = dataTable;
