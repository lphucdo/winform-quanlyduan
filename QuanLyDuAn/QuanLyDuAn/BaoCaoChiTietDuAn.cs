...
{
    public partial class BaoCaoChiTietDuAn : Form
    {
        SqlConnection conn = Dao.DAO.GetConnection();

        public BaoCaoChiTietDuAn()
        {
            InitializeComponent();
        ...
        private void BaoCaoChiTietDuAn_Load(object sender, EventArgs e)
        {
        }

        private void btnBaoCaoCT_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = DAO.GetConnection())
            {
                ...
                conn.Open();
                SqlCommand cmd = new SqlCommand("pd_ChiTietDuAn", conn);
                ...
                this.chiTietDuAnBindingSource.DataSource = dataTable;
